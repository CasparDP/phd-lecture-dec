...
$$ Total accruals_{it} = \frac{1}{AT_{i,t-1}} + \beta_1 \frac{\Delta REV_{it}}{AT_{i,t-1}} + \beta_2 \frac{PPE_{it}}{AT_{i,t-1}} + \epsilon_{it}$$
...
![](/data-prep/Figures/usitc_top5_subjects.png){fig-align="center" width="45%"}
...
:::
:::
<!-- **Navigate to:** `[your-github-repo]/jones-replication.html` -->
...
⚠️ The Earnings Management Literature has advanced
   ...
   - Alternative models, see e.g. @dechow2010understanding or @breuer2023accounting
...
⚠️ Wayback coverage varies wildly

⚠️ Keywords might be too crude/noisy

⚠️ Don't know who controls website content

⚠️ Website timing issues remain
...
<!-- **Navigate to:** `[your-github-repo]/website-analysis.html` -->
...
#### Concern #2: Wayback Coverage
**Only later firm-years & events have snapshots available**
...
#### Concern #5: Spurious Correlation
**Is any website-(accruals-)investigation correlation real or just noise?**

#### Concern #6: Using different EM measures & addressing 2-stage critique?
...
**[10 minutes: Groups share their critiques]**
...
**Replication page:** LINK

**Website analysis:** LINK
...
## Bridging the Gap
### Brainstorming Ideas for Website Data

:::{.columns}
::: {.column width="50%"}
#### When Ms Jones wrote this paper in 1991...
- One financial statement for all audiences
- Limited tools for strategic communication
- No firm websites existed
:::
...
- Opportunity for audience-specific messaging
:::
:::

:::::: {.callout}
# Question
Would firms strategically manage website disclosures during import relief investigations?
::::::

# We have a plan, right?

![](https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExdTZ1M2w0Ymplbmw3NG45YjFwNm0wc3V2aWE0NTV3ZjFlaDBncTBrcSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l3vR6aasfs0Ae3qdG/giphy.gif)
...
- Combines classic EM setting with new data source
- Tests multi-audience signaling theory
- Distinguishes real injury from accounting manipulation
- Resurrects high-impact study with modern methods
...
*Event study around investigation announcement*

#### What we'd love as outcome variables...

- Jones discretionary accruals (replicate original)
- Website sentiment (forward-looking statements)
- "Injury" language frequency (job losses, foreign competition, expansion, investment)
- Content changes (products emphasized, news released)
- Section-specific tone (IR vs Products vs Careers)


## PART 2: BRAINSTORMING
### Phase 2: Let's Get Specific

:::: {.columns}
::: {.column width="50%"}
#### Shopping List
- ITC investigation dates & outcomes ✅
- Compustat financials (for Jones model) ✅
- Wayback Machine website snapshots/website data (as text) ✅
- Text analysis tools (sentiment, topic modeling)
- ...?
:::
::: {.column width="50%"}
#### What I would do...
- Collect data (ITC, Compustat, Wayback Machine)
- Replicate Jones (1991) discretionary accruals
- Check if there is "action" in using website data
